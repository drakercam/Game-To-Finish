...
namespace Draker {
    ...
    void GameState::createAreas() {
        ...
        // Create the left border: 8 x 48, flush with left side. (AREA ONE)
        ...
        // Create the right border: 8 x 48, flush with right side. (AREA THREE)
        ...
        // Create the top border: 48 x 8, flush with top side. (AREA TWO)
        ...
        // Create the bottom border: 48 x 8, flush with bottom side. (AREA FOUR)
